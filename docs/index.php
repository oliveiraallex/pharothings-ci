<?php 
$remoteRepoFile='https://github.com/oliveiraallex/pharothings-ci/blob/master/docs/index.html';
$remotePage='https://oliveiraallex.github.io/pharothings-ci/index.html';
